...
> Status index (USER_STORIES.md): done 11 | partial 5 | planned 2 | cut 1.
> Latest amendment: MAIL-A3 — The baseline widget set (supersedes §4.1 "7 Themes, 11 Widgets") {#MAIL-A3}
