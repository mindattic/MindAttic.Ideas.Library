...
> Status index (USER_STORIES.md): done 9 | partial 5 | planned 2 | cut 1.
> Latest amendment: MAIL-A2 — Textbox: Control kind folded to Widget (supersedes §4.1 "1 Control") {#MAIL-A2}
